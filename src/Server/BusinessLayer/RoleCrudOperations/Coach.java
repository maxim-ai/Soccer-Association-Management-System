...
public class Coach extends Role implements Pageable, Serializable
{
  ...
  /**
   * returns the index of the Server.BusinessLayer.OtherCrudOperations.Team in the list
   */
  ...
  public void updateDetails(String training,String teamRole)
  {
    ...
    Logger.getInstance().writeNewLine("Server.BusinessLayer.RoleCrudOperations.Coach "+super.getName()+" update details to : "+training+","+teamRole);
  }
