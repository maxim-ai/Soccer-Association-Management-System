...
public class Player extends Role implements Pageable, Serializable
{
  ...
  public void updateDetails(Date birthday, PositionEnum position, Team team)
  {
    ...
    setTeam(team);
    pageUpdated();
    Logger.getInstance().writeNewLine("Server.BusinessLayer.RoleCrudOperations.Player "+super.getName()+" update details to "+birthday.toString()+", "+position.name()+", "+team.getName());
  }
  ...
  public void ShowPlayer() {
    ...
    System.out.println();
    System.out.println("Server.BusinessLayer.OtherCrudOperations.Team:");
