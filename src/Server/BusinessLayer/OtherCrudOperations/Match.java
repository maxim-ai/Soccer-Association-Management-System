...
//  private int day;
  ...
  public boolean setStadium(Stadium aStadium)
  {
    ...
    if(mainReferee!=null&&lineRefereeOne!=null&lineRefereeTwo!=null) {
      OurSystem.notifyOtherRole("Game between " + awayTeam.getName() + " and " + homeTeam.getName() + " update to Server.BusinessLayer.OtherCrudOperations.Stadium: " + stadium.getName(), mainReferee);
      OurSystem.notifyOtherRole("Game between " + awayTeam.getName() + " and " + homeTeam.getName() + " update to Server.BusinessLayer.OtherCrudOperations.Stadium: " + stadium.getName(), lineRefereeOne);
      OurSystem.notifyOtherRole("Game between " + awayTeam.getName() + " and " + homeTeam.getName() + " update to Server.BusinessLayer.OtherCrudOperations.Stadium: " + stadium.getName(), lineRefereeTwo);
    }
    wasSet = true;
    return wasSet;
  }
  ...
  public void ShowMatch(){
    ...
    System.out.println();
    System.out.println("Server.BusinessLayer.OtherCrudOperations.Stadium:");
    System.out.println(this.getStadium().getName());
    System.out.println();
    System.out.println("Server.BusinessLayer.OtherCrudOperations.Season:");
