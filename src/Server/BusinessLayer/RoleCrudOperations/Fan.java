...
public class Fan extends Role implements Serializable
{
  ...
  public void Logout(){
    ...
    (Logger.getInstance()).writeNewLine("Server.BusinessLayer.RoleCrudOperations.Fan "+this.getName()+" logged out");
  }
  ...
  public void Report(String report){
    ...
    (Logger.getInstance()).writeNewLine("Server.BusinessLayer.RoleCrudOperations.Fan "+this.getName()+" sent report to the system manager");
  }
