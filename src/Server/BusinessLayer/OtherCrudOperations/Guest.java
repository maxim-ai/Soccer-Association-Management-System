...
public class Guest implements Serializable {
  ...
  {
    return "Server.BusinessLayer.OtherCrudOperations.Guest ID: "+id;
  }
  //endregion
...
//    throw new Exception("Username does not exist");
  ...
  public void Filter(String category,String roleFilter){
    if(category.equals("Server.BusinessLayer.RoleCrudOperations.Role")){
    ...
    if(category.equals("Server.BusinessLayer.OtherCrudOperations.Team")){
      for(Team team: DataController.getTeams())
        team.ShowTeam();
    }
    if(category.equals("Server.BusinessLayer.OtherCrudOperations.League")){
      for(League league: DataController.getLeagues())
        league.ShowLeague();
    }
    if(category.equals("Server.BusinessLayer.OtherCrudOperations.Season")){
      for(Season season: DataController.getSeasons())
        season.ShowSeason();
    }
  }
