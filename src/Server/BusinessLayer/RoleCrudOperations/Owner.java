...
public class Owner extends Role implements Serializable {
    ...
    public Owner(String userName){setUsername(userName);}
    ...
    public boolean removeAssetFromTeam(Object o) throws Exception {
        ...
        if (this.team == null)
            ...
            Logger.getInstance().writeNewLine(this.getUsername()+" removed the Server.BusinessLayer.RoleCrudOperations.Coach"+((Coach) o).getUsername() +" from the team:" + team.getName());
            ...
            Logger.getInstance().writeNewLine(this.getUsername()+" removed the Server.BusinessLayer.RoleCrudOperations.Player"+((Player) o).getUsername() +" from the team:" + team.getName());
            ...
            Logger.getInstance().writeNewLine(this.getUsername()+" removed the Server.BusinessLayer.OtherCrudOperations.Stadium"+((Stadium) o).getName() +" from the team:" + team.getName());
    ...
    public boolean editTeamAsset(Object o, int action, String input) throws Exception {
        ...
        if (o instanceof TeamManager)
        {
            if(action==1)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the name of the Server.BusinessLayer.OtherCrudOperations.Team manager "+((TeamManager) o).getUsername() +" to be:" + input);
        ...
        else if (o instanceof Coach)
        {
            if(action==1)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the name of the Server.BusinessLayer.RoleCrudOperations.Coach "+((Coach) o).getUsername() +" to be:" + input);
                return ((Coach)o).setName(input);
            }
            else if(action==2)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the training of the Server.BusinessLayer.RoleCrudOperations.Coach "+((Coach) o).getUsername() +" from "+((Coach) o).getTraining()+" to be:" + input);
                return ((Coach)o).setTraining(input);
            }
            else if(action==3)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the team role of the Server.BusinessLayer.RoleCrudOperations.Coach "+((Coach) o).getUsername() +" from "+((Coach) o).getTeamRole()+" to be:" + input);
        ...
        else if (o instanceof Player)
        {
            if(action==1)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the name of the Server.BusinessLayer.RoleCrudOperations.Player "+((Player) o).getUsername() +" to be:" + input);
            ...
            else if(action==2)
            {
                ...
                try {
                    ...
                    Logger.getInstance().writeNewLine(this.getUsername()+" changed the birthday of the Server.BusinessLayer.RoleCrudOperations.Player "+((Player) o).getUsername() +" from "+((Player) o).getBirthday()+" to be:" + input);
            ...
            else if(action==3)
            {
                try
                {
                    Logger.getInstance().writeNewLine(this.getUsername()+" changed the position of the Server.BusinessLayer.RoleCrudOperations.Player "+((Player) o).getUsername() +" from "+((Player) o).getPosition()+" to be:" + input);
            ...
            if(action==1)
            {
                Logger.getInstance().writeNewLine(this.getUsername()+" changed the name of the Server.BusinessLayer.OtherCrudOperations.Stadium "+((Stadium) o).getName() +" to be:" + input);
    ...
    public boolean appointTeamManagerToTeam(Account account,List<TeamManager.PermissionEnum> permissions) throws Exception {
        ...
        Logger.getInstance().writeNewLine(this.getUsername()+" appointed "+account.getUserName()+" to be an Server.BusinessLayer.OtherCrudOperations.Team manager on team "+ team.getName());
    ...
    public boolean removeTeamManagerFromTeam(TeamManager teamManager) throws Exception {
        ...
        Logger.getInstance().writeNewLine(this.getUsername()+" removed "+teamManager.getUsername()+"'s permission as a Server.BusinessLayer.OtherCrudOperations.Team manager on team "+team.getName());
    ...
    public void ShowOwner(){
        ...
        System.out.println("Server.BusinessLayer.OtherCrudOperations.Team owned:");
