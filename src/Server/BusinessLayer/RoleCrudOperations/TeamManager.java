...
public class TeamManager extends Role implements Serializable
{
  ...
  public TeamManager(String userName){setUsername(userName);}
  ...
  public boolean removeCoach(Coach aCoach) throws Exception {
    ...
    Logger.getInstance().writeNewLine(this.getUsername()+" removed the Server.BusinessLayer.RoleCrudOperations.Coach"+(aCoach.getUsername() +" from the team:" + team.getName()));
  ...
  public boolean removePlayer(Player aPlayer) throws Exception {
    ...
    Logger.getInstance().writeNewLine(this.getUsername()+" removed the Server.BusinessLayer.RoleCrudOperations.Player"+(aPlayer.getUsername() +" from the team:" + team.getName()));
  ...
  public boolean setLeague(League aLeague) throws Exception {
    ...
    Logger.getInstance().writeNewLine(this.getUsername()+" set the Server.BusinessLayer.OtherCrudOperations.League of the team "+team.getName()+" to be "+aLeague.getName());
  ...
  public void ShowTeamManager(){
    ...
    System.out.println();
    System.out.println("Server.BusinessLayer.OtherCrudOperations.Team managed:");
