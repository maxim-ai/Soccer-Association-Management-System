...
public class Owner extends Role {
    ...
    public String createTeam(String teamName,League league, Stadium stadium)
    {
        ...
        else if(!AssiciationRepresentive.checkIfRequestExists(this,teamName))
        {
            for(AssiciationRepresentive ar:DataManager.getAssiciationRepresentivesFromAccounts())
            {
                Alert.notifyOtherRole(getName()+" is requesting to create a new team, teamName: "+teamName,ar);
                AssiciationRepresentive.addOpenTeamRequest(this,teamName);
            }
            return "Request sent, waiting for approval";
        }
        else
        {
            if(!AssiciationRepresentive.getRequestStatus(this,teamName))
            ...
            else
            {
                ...
                AssiciationRepresentive.removeOpenTeamRequest(this,teamName);
